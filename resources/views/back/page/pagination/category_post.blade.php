@foreach($category_post_pagination as $articles)
<div class="card article-lists" id="categoryPost{{ $articles->id }}" data-id="{{ $articles->id }}"
    onclick="chooseCategoryPost(this)">
    <div class="card-body">
        <div class="row">
            <div class="col-sm-6">
...
<div class="d-flex justify-content-center">
    {!! $category_post_pagination->render('vendor.pagination.custom') !!}
</div>