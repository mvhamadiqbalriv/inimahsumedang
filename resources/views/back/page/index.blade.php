    ...
    <div class="col-sm-6">
        <div class="card p-2">
            <div class="card-body">
                ...
                <div class="wrap-image mt-4">
                    @if (!empty($feature_post))
                    <img src="{{ Storage::url($feature_post->gambar) }}" class="img-fluid image " alt="post-title" />
                    @else
        ...
        <div class="card p-2">
            <div class="card-body">
                ...
                <div class="row justify-content-center mt-4">
                    <div class="col-sm-6">
                        <div class="wrap-editors-pick-images mt-4" data-toggle="modal" data-target="#selectedArticleModal" data-status="editors_pick_1" data-title="Editors Pick" onclick="editorsPickValue(this)">
                            @if (!empty($editors_pick_1))
                            <img src="{{ Storage::url($editors_pick_1->gambar) }}" class="img-fluid image" style="width: 510px;" alt="post-title" />
                            @else
                            <img src="{{ asset('assets/back/not-found.png') }}" class="img-fluid editors-pick-image"
